# Project_Red_Queen Architecture Analysis
...
- **Modules Analyzed**: 0
- **Key Dependencies**: @radix-ui/react-alert-dialog, @radix-ui/react-slot, @tailwindcss/postcss, @testing-library/jest-dom, @testing-library/react
